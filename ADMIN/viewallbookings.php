      ...
      <div class="col-md-9">
          ...
          <br/>
           <table class="table table-striped" style="border:1px solid black">
                        ...
                        $sql = "SELECT booking.dat,booking.bid,booking.name,booking.email,booking.phone,booking.total,parking.name as pname,address,booking.status FROM booking join parking on booking.pid=parking.pid";
