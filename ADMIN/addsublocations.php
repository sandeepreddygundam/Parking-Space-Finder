  ...
  <div class="row">
     ...
     <a href="viewusers.php" style="color:white;margin:10px;font-size:20px;text-align:left"><button class="btn btn-danger form-control" style="text-align:left;font-size:20px;height:70px">User Information</button></a><br/>
      ...
      <div class="col-md-9">
          ...
          <h3>Add Sub Locations</h3>
          
          <p style="text-align:right">
               <a href="managesublocations.php" style="color:white;margin:10px;font-size:20px;text-align:left" >
          ...
          <br/>
           ...
           <form method="POST" action="addsublocation.php" enctype="multipart/form-data">
