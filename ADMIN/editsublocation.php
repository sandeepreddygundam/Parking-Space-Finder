     ...
     <a href="viewusers.php" style="color:white;margin:10px;font-size:20px;text-align:left"><button class="btn btn-danger form-control" style="text-align:left;font-size:20px;height:70px">User Information</button></a><br/>
      ...
      <div class="col-md-9">
          ...
          <br/>
           ...
           <form method="POST" action="editsublocations.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <label>Location Id</label>
                           <input class="form-control"  id="lid" name="lid" type="text" value="<?php echo $_GET['id'] ?>" placeholder="Enter Location name" readonly required>
                       </div>
