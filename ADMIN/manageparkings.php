     ...
     <a href="viewusers.php" style="color:white;margin:10px;font-size:20px;text-align:left"><button class="btn btn-danger form-control" style="text-align:left;font-size:20px;height:70px">User Information</button></a><br/>
      ...
      <div class="col-md-9">
          ...
          <p style="text-align:Left">
               <a href="addparking.php" style="color:white;margin:10px;font-size:20px;text-align:left" >
              <button class="btn btn-danger" >Add Parking</button></a>
          </p>
           ...
           <table class="table table-striped" style="border:1px solid black">
                        ...
                        if ($result) {
                            ...
                            <td>
                             ...
                             <a href='editparking.php?id=" . $row['pid'] . "&name=" . $row['name'] . "&address=" . $row['address'] . "&p_hour=" . $row['p_hour'] . "&p_month=" . $row['p_month'] . "'>
                                            <img src='images/edit.jpeg' style='width:50px'/>
                                        </a>
                              <a href='deleteparking.php?id= " . $row['pid'] . "'> <img src='images/delete.jpeg' style='width:50px'/> </a>
